...
@Component({
  selector: 'app-order-details-customer',
  standalone: true,
  imports: [CommonModule, TotalOrderPipe],
  templateUrl: './order-details-customer.component.html',
  styleUrl: './order-details-customer.component.css'
})
export class OrderDetailsCustomerComponent implements OnInit {
